...
public class ExcelMonitor {
	public static void main(String[] args) {
		...
		//String filePath = "C:\\FullStackJavaCourse\\18.DevOpAdv\\Practice\\ScienceFair\\src\\main\\java\\ScienceFair\\ScienceFair\\ScienceFair.xlsx";
		File file = new File("src/main/java/ScienceFair/ScienceFair/ScienceFair.xlsx");
